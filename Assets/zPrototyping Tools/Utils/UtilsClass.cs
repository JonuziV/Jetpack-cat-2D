...
namespace Prototyping.Utils {
    ...
    public static class UtilsClass {
        ...
        // Create a Sprite in the World, no parent *sad violin music* 
        ...
        // Create a Sprite in the World with Button_Sprite, no parent *more sad violin*
        ...
        // Create a Text Popup in the World, no parent (So many orphans... sheesh D:)
        ...
        // Return a number with the milli dots, 1000000 -> 1.000.000
        ...
        public static string GetRandomCityName() {
            List<string> cityNameList = new List<string>(){"Tokyo","New York","Bangkok","Kabul","Lisbon","Tirana","Algiers","Antananarivo","Lilongwe","Kuala Lumpur",
                            "Androra la Vella","Male","Bamako","Valletta","Majuro","Nouakchott","Port Louis","Mexico City","Palikir","Chisinau","Monaco",
                            "Luanda","Saint John's","Buenos Aires","Yerevan","Canberra","Vienna","Baku",
                            "Nassau","Manama","Dhaka","Bridgetown","Minsk","Brussels","Belmopan","Porto-Novo","Thimphu",
                            "Sucre, La Paz","Sarajevo","Ulaanbaatar","Podgorica","Rabat","Maputo","Naypyidaw","Windhoek","Yaren District","Kathmandu",
                            "Amsterdam","Gaborone","Brasilia","Bandar Seri Begawan","Sofia","Ouagadougou","Gitega","Praia","Phnom Penh","Yaounde","Ottawa",
                            "Bangui","Wellington","Managua","Niamey","Abuja","Pyongyang","Skopje","Oslo","Muskat","Islamabad","N'Djamena",
                            "Santiago","Beijing","Bogota","Moroni","Kinshasa","Brazzaville","San Jose","Yamoussoukro","Zagreb",
                            "Havana","Ngerulmud","Jerusalem","Panama City","Port Moresby","Asuncion","Lima","Manila","Warsaw","Lisbon",
                            "Doha","Nicosia","Bucharest","Moscow","Kigali","Basseterre","Castries","Kingstown",
                            "Apia","San Marino","Sao Tome","Riyadh","Prague","Copenhagen","Djibouti","Roseau","Santo Domingo","Quito",
                            "San Salvador","Malabo, Oyala","Asmara","Tallinn","Mbabane, Lobamba","Addis Ababa","Suva","Helsinki","Paris",
            "Libreville","Dakar","Belgrade","Victoria","Freetown","Singapore","Bratislava", "Ljubljana","Honiara","Mogadishu","Tbilisi"
        };
